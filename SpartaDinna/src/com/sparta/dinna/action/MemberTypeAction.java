...
import com.sparta.dinna.service.MemberTypeService;
...
@Controller
@RequestMapping("/dinna/memberType")
public class MemberTypeAction
{
	...
	{
		PageData<MemberType> pageData = new PageData<MemberType>();
		//给pageData设置参数
		WebUtils.setPageDataParameter(request, pageData);
		pageData = memberTypeService.find(pageData);
	...
	{
		return "/dinna/memberType/input";
	}

	@RequestMapping(value = "/edit/{id}")
	public String editForm(@PathVariable("id") Integer id, Model model)
	{
		MemberType memberType = memberTypeService.find(id);
		model.addAttribute(memberType);
		return "/dinna/memberType/input";
	}

	@RequestMapping(value = "/save", method = RequestMethod.POST)
	public String save(MemberType memberType)
	{
		if (memberType.isNew())
		{
		...
		return "redirect:/dinna/memberType/list";//重定向
	}
	...
	{
		memberTypeService.unVisible(id);
		return "redirect:/dinna/memberType/list";//重定向
	}
