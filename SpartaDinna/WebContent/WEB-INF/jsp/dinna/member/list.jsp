...
<div id="container" class="container_24">
  ...
  <div id="content" class="container_24">
    <div class="container_24">
      <div class="area2">
        <!-- 分页显示演示开始 -->
        <form id="listForm" action="${ctx}/dinna/member/list" method="get">
          ...
          <table>
            <tr align="center">
              <th>id: <y:search fieldType="I" fieldList="id" matchType="EQ" />
                ...
                <a href="${ctx}/dinna/member/new">添加新member</a>
              </th>
            </tr>
          </table>
        </form>
      ...
      <div class="area">   
          <table  class="listtable">
            <tr class="line">
				<th><a href="javascript:sort('memberId')">memberId</a></th>
			
				<th><a href="javascript:sort('memberName')">memberName</a></th>
			
				<th><a href="javascript:sort('memberTel')">memberTel</a></th>
			
				<th><a href="javascript:sort('memberPass')">memberPass</a></th>
			
				<th><a href="javascript:sort('memberIDcard')">memberIDcard</a></th>
			
				<th><a href="javascript:sort('sex')">sex</a></th>
            ...
            <c:forEach var="entity" items="${pageData.result}">
              <tr <c:if test="${!entity.visible}">bgcolor="#AFEEEE"</c:if>>
					...
					<td>${entity.memberTel}</td>
				
					<td>${entity.memberPass}</td>
				
					<td>${entity.memberIDcard}</td>
                ...
                <td>
                	<a href="${ctx}/dinna/member/edit/${entity.id}">修改</a> |
                	<a href="${ctx}/dinna/member/delete/${entity.id}" onClick="return confirm('删除后无法恢复,确定要删除吗?');">刪除</a> |
                  <c:choose>
                    <c:when test="${entity.visible}"> 
                    	显示 |  <a href="${ctx}/dinna/member/unVisible/${entity.id}">不显示</a>
                    </c:when>
                    <c:otherwise> 
                    	<a href="${ctx}/dinna/member/visible/${entity.id}">显示</a> | 不显示 
                    </c:otherwise>
                  </c:choose>
                </td>
              </tr>
